...
class StockEnvValidation(gym.Env):
    ...
    def step(self, actions):
        ...
        if self.terminal:
            ...
            plt.savefig('/Users/poteman/learn/RL/ReinforcementLearning_for_stock/archive/account_value_validation_{}.png'.format(self.iteration))
            plt.close()
            df_total_value = pd.DataFrame(self.asset_memory)
            df_total_value.to_csv('/Users/poteman/learn/RL/ReinforcementLearning_for_stock/archive/account_value_validation_{}.csv'.format(self.iteration))
